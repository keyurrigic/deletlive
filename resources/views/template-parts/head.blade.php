...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;0,900;1,800&family=Raleway:ital,wght@0,400;0,500;0,700;1,500&display=swap"
        rel="stylesheet">
