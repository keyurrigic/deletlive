    ...
    <form id="join-form">
      <div class="row join-info-group" style="display:none">
        <div class="col-sm sso-hidden">
          ...
          <input id="appid" type="text" placeholder="Enter the appid" value="2ce084ae41e245cbb6e48888a0b422f5">
        ...
        <div class="col-sm sso-hidden">
          ...
          <input id="token" type="text" placeholder="Enter the app token" value="<?php echo $_GET['token']; ?>">
        </div>
        <div class="col-sm">
          <p class="join-info-text">Channel Name</p>
          <input id="channel" type="text" placeholder="Enter the channel name" required value="<?php echo $_GET['channel']; ?>">
        </div>
        <div class="col-sm">
          <p class="join-info-text">User ID(optional)</p>
          <input id="uid" type="text" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"
            onafterpaste="this.value=this.value.replace(/[^0-9]/g,'')" placeholder="Enter the user ID" value="<?php echo $_GET['uid']; ?>">
        </div>
      </div>
